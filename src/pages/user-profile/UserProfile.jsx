            ...
            <Box className="c1">
              <Box className="c11">
                <Typography
                  ...
                  variant={'h3'}
                >
                  {t('user-page.greetings')} {userName}
                </Typography>
              </Box>
            </Box>
          </Box>
        ...
        <Grid item sm={6} padding={3}>
          ...
          >
            <Avatar
              ...
              src={localStorage.getItem('summoner-icon')}
            />
          </Grid>
            ...
            <Box>
              ...
              >
                ...
                <Grid item sm={12}>
                  <Box display="flex" flexDirection="row">
                    <Button
                      onClick={() =>
                        navigate(
                          `/user/my-gallery/artworks/${localStorage.getItem}`
                        )
                      }
                      variant="outlined"
                    >
                      {t('user-page.upload-artwork')}
                    </Button>
                  </Box>
                </Grid>
                ...
                <Grid item sm={12}>
                  <Box display="flex" flexDirection="row">
                    <Button
                      onClick={handleLFTButton}
                      disabled={!isCustomProfileCreated}
                      variant="outlined"
                    >
                      {getLFTButtonMessage()}
                    </Button>
